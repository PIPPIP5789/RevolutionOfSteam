...
//import xyz.brassgoggledcoders.steamagerevolution._temp.blocks.FirstBlock;
...
public class SARBlocks {
    ...
    public static Block blockFirstBlock;
    ...
    public static void registerBlocks(BlockRegistry blockRegistry) {
        ...
        //blockFirstBlock = new FirstBlock();

        // ----------------

        //blockRegistry.register(blockFirstBlock);
